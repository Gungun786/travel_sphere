import type { ItineraryDay, BudgetBreakdown, Expense, Settlement, ItineraryVote } from '@/types';
...
export const mockVotes: ItineraryVote[] = [
  {
    id: 'v1',
    memberId: 'm1',
    memberName: 'Gungun',
    ...
    vote: 'approve',
    review: 'The itinerary is balanced and fits our budget. Love the houseboat day!',
    timestamp: '2h ago',
  },
  {
    id: 'v2',
    ...
    vote: 'approve',
    review: 'Great mix of nature and culture. Munnar day looks perfect.',
    timestamp: '1h ago',
  },
  {
    id: 'v3',
    ...
    vote: 'reject',
    review: 'Too many activities on Day 2. Would prefer more adventure activities like trekking instead of the Tea Museum.',
    timestamp: '45m ago',
  },
  {
    id: 'v4',
  ...
  },
  {
    ...
    vote: 'approve',
    review: 'Relaxed pace on Day 3 with the houseboat. Exactly what I wanted.',
    timestamp: '30m ago',
  },
];
